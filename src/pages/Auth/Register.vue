<template>
  <v-container>
    <v-row>
      <v-col>
        <authorization>
          <v-card slot-scope="{ user, config, register }" class="mx-auto mt-5" max-width="800">
            <v-card-title>
            ...
            <v-card-text>
              <v-form>
                ...
                <v-text-field
                  ...
                  @blur="config.$v.user.email.$touch()"
                />
                <v-text-field
            ...
            <v-card-actions>
              <v-checkbox
                v-model="user.agreeToTerms.value"
                label="Agree to terms & conditions"
                :error-messages="user.agreeToTerms.errorMessages"
                @change="config.$v.user.agreeToTerms.$touch()"
              />
              <v-spacer />
              <v-btn
                color="success"
                :disabled="config.$v.$invalid"
                @click="register"
                >Register</v-btn
              >
